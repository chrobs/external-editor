...
function launchExtEdit() {
  ...
  if (prefEditHeaders[extedit_GLOBAL]) {
    ...
    if (prefEditHeaders[extedit_SUBJECT]){
      if(subject == ""){
        content += extedit_SUBJECT + ": <++>" + newLine;
      } else {
        content += extedit_SUBJECT + ":   " + subject + newLine;
      }
    }

    if (prefEditHeaders[extedit_TO]){
      if(msgCompFields.to == ""){
        content += extedit_TO + ": <++>" + newLine;
      } else {
        content += extedit_TO + ":        " + msgCompFields.to + newLine;
      }
    }

    if (prefEditHeaders[extedit_REPLY_TO]){
      if(msgCompFields.replyTo == ""){
        content += extedit_REPLY_TO + ": <++>" + newLine;
      } else {
        content += extedit_REPLY_TO + ":  " + msgCompFields.replyTo + newLine;
      }
    }
